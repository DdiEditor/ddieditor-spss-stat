...
public class IdElementContentHandler extends DefaultHandler {
	...
	String[] attNames = { "id", "version", "agency", "name" };
	...
	public void startElement(String uri, String localName, String qName,
		...
		result.put(
				...
				new IdElement(attributes.getValue(uri, attNames[0]), attributes
						.getValue(uri, attNames[1]), attributes.getValue(uri,
						attNames[2]), attributes.getValue(uri, attNames[3])));
		}
	}
}
